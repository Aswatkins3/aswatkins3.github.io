...
const CONFIG = {
  github: {
    username: 'aswatkins3', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['aswatkins3/Projects', 'aswatkins3/Bioinformatics'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  seo: {
    title: 'Portfolio of Ally Watkins',
    description: '',
    imageURL: '',
  },
  social: {
    ...
    skype: '',
    telegram: '',
    website: 'https://aswatkins3.github.io',
    phone: '',
    email: 'awatkins3@csustan.edu',
  },
  resume: {
    fileUrl:
